    ...
    <div class="info-content" id="showContent${index}">
        ...
        <div class="informations">
            ...
            <div class="mobile-popup-menu slide-out" id="mobilePopupMenu" style="display: none;">
                <img id="mobile-edit" src="../assets/svg/edit_contact_icon_default.svg" onclick="editContactEvent(${index}, event)">
                <img id="mobile-delete" src="../assets/svg/delete_contact_icon_default.svg" onclick="deleteContact(${index})">
            </div
     </div>
        </div>
    </div>
